...
class Users (Resource):
	...
	def post(self):
		...
		response = add_user (user_info['username'], user_info['email'], user_info['password'])
		return response
...
class Authenticate (Resource):
	...
	def post(self):
		...
		result = get_token (public_id, password, app.config['SECRET_KEY'])
		return result
